"""
Method Registry Module for Vector Store

This module provides a method registry system for registering custom vector store methods,
enabling extensibility and community contributions to the vector store toolkit.

Supported Registration Types:
    - Method Registry: Register custom vector store methods for:
        * "store": Vector storage methods
        * "search": Vector search methods
        * "index": Index creation/management methods
        * "hybrid_search": Hybrid search methods
        * "metadata": Metadata management methods
...
Key Features:
    - Method registry for custom vector store methods
    - Task-based method organization (store, search, index, hybrid_search, metadata, namespace)
    - Dynamic registration and unregistration
    - Easy discovery of available methods
    - Support for community-contributed extensions

Main Classes:
    - MethodRegistry: Registry for custom vector store methods
...
Example Usage:
    ...
    >>> method_registry.register("store", "custom_method", custom_store_function)
...
class MethodRegistry:
    """Registry for custom vector store methods."""
