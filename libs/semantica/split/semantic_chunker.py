...
class SemanticChunker:
    ...
    def __init__(self, **config):
        ...
        if SPACY_AVAILABLE:
            ...
            try:
                ...
                self.logger.warning(f"spaCy model {model_name} not found. Using fallback chunking.")
    ...
    def _chunk_with_spacy(self, text: str, **options) -> List[Chunk]:
        ...
        for sentence in sentences:
            ...
            potential_chunk = current_chunk_text + " " + sentence_text if current_chunk_text else sentence_text
        ...
        if current_chunk_text.strip():
            ...
            end_pos = start_pos + len(current_chunk_text.strip()) if start_pos >= 0 else len(text)
